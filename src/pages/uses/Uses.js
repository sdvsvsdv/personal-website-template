                            ...
                            <div className='cards two'>
                                <div className='card'>
                                    ...
                                    <div className='content'>
                                        ...
                                        <p className='second'>How we used world-class visual design to attract a great team, win over customers, and get more press for Planetaria.</p>                                    </div>
                                </div>
                                <div className='card card-2'>
                                    <div className='date'></div>
                                    <div className='content'>
                                        <p className='first' style={{color: backstate? "black" : "white"}}>Bootstrapping an aerospace company to $17M ARR</p>
                                        <p className='second'>The story of how we built one of the most promising space startups in the world without taking any capital from investors.</p>                                    </div>
                                </div>
